...
student products die there, not because they were bad but because nobody was ever told
about them. This chapter is how people find out.
...
Reaching customers is one thing; getting people to *back* you is another. Users decide whether to trust a stranger's product, mentors decide whether to spend time on you, and, later, investors or a boss decide whether to fund you. Jeff Dyer and his colleagues call the ability to attract that support **innovation capital**, and they show it is something you build on purpose, from three sources:
...
- **Reputation capital** — what you have done: your track record. A shipped product with real users is reputation you can point to, and it is the cheapest kind to earn as a student. You just ship and show.

Take an honest inventory of all three now. Your go-to-market is far stronger when you can show not only a product, but a credible builder, with a network and a track record, standing behind it. You will spend the final demo turning that capital into belief.
...
Do not try to reach everyone at once. Geoffrey Moore's *Crossing the Chasm* argues you should win a single narrow segment completely before you expand, a **beachhead**: a small market you can dominate, become the obvious choice for, and use as a base to move outward. For you as a student, the beachhead might be one dorm, one club, one type of small business in Provo. Own that first. A product that ten people love beats one that a thousand people shrug at.
...
People rarely decide on logic alone. Robert Cialdini's research names six levers that move real decisions, worth using honestly, and worth recognizing when they are used on you:
...
These amplify a true offer; they do not substitute for one. Used to push a product that does not deliver, they become manipulation, the line drawn in [Product Morality](03-what-is-worth-building.qmd).
...
- *Obviously Awesome* by April Dunford [@dunford2019obviously] → Positioning masterclass
...
#### The User Lifecycle [@mcclure2007]
...
and exactly one chance to learn from it, and an uninstrumented launch throws that away. Put
event tracking in before you send anyone the link. The mechanics are in
...
- **Positioning**: what you are, for whom, and why you over the alternative.
...
- **Growth and retention**: acquisition is rented; retention is owned.
- **Onboarding**: the minutes that decide whether a signup becomes a user.
