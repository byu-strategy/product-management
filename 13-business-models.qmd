...
A product that cannot pay for itself is a project. The business model is the argument for
how value reaches you as well as your customer, and writing it down early surfaces the
assumptions you did not know you were making.

## Introduction

The Business Model Canvas is a strategic management tool that helps you describe, design, challenge, and pivot your business model. Created by Alexander Osterwalder [@osterwalder2010business] and refined by Jeff Dyer, it provides a visual framework for understanding how your organization creates, delivers, and captures value.
...
- You want a quick first draft to iterate on
- You're familiar with Business Model Canvas concepts
- You prefer a holistic view before diving into details

**When to use the detailed step-by-step approach below:**
- You're new to Business Model Canvas thinking
- You want deeper analysis and guided thinking for each component
- You prefer building incrementally with focused attention on each element
...
- **Business Model Canvas**: nine blocks describing how a business creates, delivers, and captures value.
- **Customer segments**: who you serve, stated narrowly enough to act on.
- **Value proposition**: the specific gain or pain relief you deliver.
- **Revenue streams**: how value returns to you, and on what cadence.
- **Cost structure**: what you must spend regardless of whether anyone buys.
- **Unit economics**: what one customer costs to acquire and returns over time.
- **Break-even**: the point where cumulative revenue overtakes cumulative cost.
