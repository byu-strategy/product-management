...
Read a metric as [evidence](03-problem-discovery.qmd), not a verdict. A number moves a belief up or down; it does not certify that you are right, or that you are worthy. And remember that outcomes carry luck: a good number can follow a poor decision and a bad number a sound one. Track what updates your beliefs about the product, not what flatters them.
...
In the AI era this trap is more dangerous, not less, because output has never been cheaper. You can ship a feature a day now. So hold yourself to outcomes: did the North Star move, did activation improve, did a real user get real value? Shipping is not the goal; changing an outcome is.

*Outcomes over output, and the build trap, from Marty Cagan, Inspired / Empowered, and Melissa Perri, Escaping the Build Trap (2018).*
