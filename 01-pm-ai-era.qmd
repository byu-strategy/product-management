...
The **Aim**, what is worth building at all, is where strategy and values meet. What value you create and for whom, and how much of it you can capture, is the [create-versus-capture](product-strategy.qmd#creating-value-and-capturing-it) choice in [Product Strategy](product-strategy.qmd); whether it is worth building at all is [Product Morality](product-morality.qmd). And you will run the whole loop many times across the semester, once per sprint, because a single turn tells you little; the arc is what reveals whether you are getting good.
...
![Outcome is the area the factors enclose, not their perimeter. One weak factor collapses it.](images/outcome-as-area.svg){fig-alt="Two rectangles. The left, with all sides full, is a large shaded area labeled Outcome. The right, with the Execution side near zero, collapses to a thin sliver labeled Outcome near zero."}

Second, **most of the loop is about telling what you believe from what is true.** You will always have beliefs about your customer. Some are right, some are wrong, and the work of Inform and Reason is to close the gap. [Chapter 3](03-problem-discovery.qmd) gives you a picture of exactly that: a map of where a belief can sit relative to the truth, and how to move it.

### How we run class

Class meets once a week, and we run it like a practice, in the sense a coach like John Wooden meant it: short bursts of full attention to install a skill, then live reps building with Claude Code. Each practice has one emphasis, and we open it with a scripture and a quote tied to that emphasis.
...
Product Management, as a formal discipline and job title, traces its roots to Hewlett-Packard in the 1940s, where it emerged as a distinct driver of innovation in technology. Yet the concept predates HP: a 1931 Procter & Gamble memo introduced the role of “Brand Men,” whose responsibilities closely foreshadowed what would later be recognized as Product Management [@mcelroy1931].

![Image source: Wikimedia Commons](images/brand-men.jpg)

Early influences such as the \[Scrum development process\](https://en.wikipedia.org/wiki/Scrum\_(software_development))) and the [Agile Manifesto](https://agilemanifesto.org/) [@beck2001] reshaped how products are built, while initiatives like Google’s Associate Product Manager (APM) program and influential books helped standardize best practices. In recent years, PM has become one of the most sought-after careers, and today the field is entering a new era with the rise of the AI Product Manager.
...
In 2011, Marc Andreessen, co-founder of the venture capital firm Andreessen Horowitz (a16z) (known for its influential early investments in companies like Facebook, Airbnb, and Coinbase) famously observed that [*Software Is Eating the World*](https://a16z.com/why-software-is-eating-the-world/) [@andreessen2011].
...
Marc now predicts that [*AI Will Save the World*](https://a16z.com/ai-will-save-the-world/) [@andreessen2023], but this certainly won't happen automatically. Because human nature is what it is, there will be plenty of people using AI in ways that are damaging to both individuals and society. Indeed, we are living in the time when:
