...
The course *is* this loop. Discovery is **Inform**. Writing specs and scoping an MVP is **Reason**. Building, shipping, and growing is **Enact**. And the **Aim**, what is worth building at all, is a question of values we take up directly in [Product Morality](product-morality.qmd). You will run the loop many times across the semester, once per sprint, because a single turn tells you little; the arc is what reveals whether you are getting good.
