...
| **Office Hours**          | [Nate's Office Hours](https://calendly.com/nathanmccauley10/30min)  ,  [Taylor's Office Hours](https://calendly.com/taylorwall214/30min)|
...
This course is cross-listed under three course numbers. All sections meet together as one class, use this site, and use Canvas as the LMS. Register under whichever number fits your program.

| Course | Section | Title | Credit Hours | Instruction Mode |
|--------|---------|-------|--------------|------------------|
| MSB 341 | 002 | Product Management | 3.0 | Blended |
| IS 693R | 008 | Readings & Conference | 3.0 | Blended |
| C S 498R | 005 | Undergraduate Special Projects | 3.0 | Classroom |
...
AI Tools: - We will be using [Claude Code](https://www.anthropic.com/claude-code) throughout the course. Using Claude Code requires a paid Claude account (\~\$20 per month for the duration of the semester). Your total cost will be about \$85 after tax.
