...
AI Tools: - We will be using [Claude Code](https://www.anthropic.com/claude-code) throughout the course. This requires the Claude Max plan, which is required for the course and costs \$100 per month. You can offset this cost by applying for a [Rollins Center Validation Grant](https://programs.byucet.org/dashboard/grant/4), which reimburses up to \$500 for customer discovery and validation work on your product.
...
Every assignment and quiz is described in detail in the [Assessments section](00-assessments.qmd).
