...
| **LMS**                   | Canvas                     |
| **Class Time**            | Mondays 3:30–4:45 PM       |
| **Class Location**        | 2439 TNRB                  |

## Course Numbers

This course is cross-listed under three course numbers. It is all the same class: everyone meets together Mondays 3:30–4:45 PM in 2439 TNRB, uses this site, and uses Canvas as the LMS. Register under whichever number fits your program.

| Course | Section | Title | Credit Hours |
|--------|---------|-------|--------------|
| MSB 341 | 002 | Product Management | 3.0 |
| IS 693R | 008 | Readings & Conference | 3.0 |
| C S 498R | 005 | Undergraduate Special Projects | 3.0 |
...
AI Tools: We use [Claude Code](https://www.anthropic.com/claude-code) throughout the course, which requires a paid Claude account. **Claude Pro at \$20 per month is enough to start.** Once your build work picks up you will hit usage limits, and that is the signal to upgrade to Claude Max at \$100 per month. You can offset either cost by applying for a [Rollins Center Validation Grant](https://programs.byucet.org/dashboard/grant/4), which reimburses up to \$500 for customer discovery and validation work on your product. Setup instructions are in [Computer Setup](00-computer-setup.qmd).

You should also get Gemini for [free](https://gemini.google/students/) as this will be a useful supplement to Claude Code.

If you have other paid accounts to ChatGPT, Cursor, or others these can be used as supplements as well. 

Optional: [Innovators DNAs Resources and Assessment](https://apps.innovatorsdna.com/portal/byu-strat-2025) (special reduced price of \$20)

All other materials are available online at no cost.

## Description

This course turns product managers into full-stack AI product builders. You will pick a
problem worth solving, build a real digital product for it, put it in front of real users,
and ship it, using AI coding agents as your primary instrument throughout.

The course is organized around six builder skills: **Agentic Workflow** (building with AI as
your instrument), **Discovery** (what to build, for whom, and whether you should),
**Design** (the surface and the flow), **Application Architecture** (how it is structured,
shipped, and kept safe), **AI Systems** (the intelligence inside the product), and **Launch
and Learn** (how people find it, and whether it worked). Each gets two weeks. You will rate
yourself on all six in the first week and again in the last, and see how the shape changed.

Tooling is Claude Code, GitHub, Next.js, Supabase, and Vercel. You do not need to arrive
knowing any of them. You will ship something in week one that you do not fully understand,
and spend the rest of the semester learning what you shipped.
...
Most of your grade rides on building a real product across the semester, not on exams. This is deliberate. The research this course is built on says the thing worth certifying is authentic performance, the whole game done and iterated with feedback, not recall on a test. The two exams are proctored and closed book, which makes them the one place your own understanding is measured without AI assistance, and at 5% each they are deliberately low stakes. For the reasoning behind this design, see [Why This Class Works This Way](93-why-this-class-works.qmd).
...
Every assignment and exam is described in detail in the [Assessments section](00-assessments.qmd).
...
**Exams**: Both exams are taken in the testing center within a posted window. Windows cannot be extended, so schedule early rather than on the last day.
...
**Sprint 6**: Sprint 6 must be submitted by 11:59pm on Thu, Dec 10. It cannot be turned in late for credit.

**Final Exam**: The Final Exam must be completed within the testing center window, Dec 14 to 17. It cannot be taken late.
