...
| Sprint | [Sprint 1 - Ship & Showcase](#sprint-1-ship-showcase) | 50 | 4, 5 |
| Sprint | [Sprint 2 - Validate & Commit](#sprint-2-validate-commit) | 50 | 2, 3 |
| Sprint | [Sprint 3 - Product MVP](#sprint-3-product-mvp) | 50 | 4, 5 |
| Sprint | [Sprint 4 - Progress Check](#sprint-4-progress-check) | 50 | 4, 5 |
| Sprint | [Sprint 5 - Progress Check](#sprint-5-progress-check) | 50 | 4, 5 |
| Sprint | [Sprint 6 - Launch and Learn](#sprint-6-launch-and-learn) | 100 | 2, 4, 5 |
...
**50 points | Assigned: Mon, Sep 28 | Due: Mon, Oct 12, 11:59pm**
...
**What you turn in:** A single Google Doc link on Canvas using the [Sprint 3 Submission Template](https://docs.google.com/document/d/14DCFSVRxwG4djSrESHcmspmy3z37scMhkmGpJSkGyPc/copy). Your Google Doc collects all links (Updated Portfolio, GitHub, Vercel, Loom recordings) and written deliverables in one place.
...
**Deliverable:** GitHub URLs to your CLAUDE.md and spec documents committed to your repo. Share your report with sdmurff and nmccaul if private.
...
Now that your core feature works, watch real people try to use it. For deeper background, see [Chapter 6](06-testing-the-design.qmd).
...
Document your platform strategy decision. For deeper background, see [Interface and Flow](05-interface-and-flow.qmd).
...
Submit your completed Google Doc link on Canvas. Use the [Sprint 3 Submission Template](https://docs.google.com/document/d/14DCFSVRxwG4djSrESHcmspmy3z37scMhkmGpJSkGyPc/copy). Your doc should contain all links and written deliverables in one place:
...
### Sprint 4: Progress Check {#sprint-4-progress-check}
...
1. **Demo your live, deployed product** — show the real app, not slides or localhost
2. **Show what's new or improved** since Sprint 3
3. **Explain why** you chose to work on what you did
4. **State what you're planning next**

**Submit:** Your Loom URL on Canvas.
...
### Sprint 5: Progress Check {#sprint-5-progress-check}

**50 points | Assigned: Mon, Nov 9 | Due: Mon, Nov 23**

**Goal:** Continue building. This is your last progress check before the finish line.
...
1. **Demo your live, deployed product** — show the real app, not slides or localhost
2. **Show what's new or improved** since Sprint 4
3. **Explain why** you chose to work on what you did
4. **Describe your plan for the final submission** — what still needs to happen?
...
### Sprint 6: Launch and Learn {#sprint-6-launch-and-learn}

**100 points | Assigned: Mon, Nov 23 | Due: Thu, Dec 10**

**Goal:** Get what you built in front of real people, find out what happened, and tell the story of building it.

This is the last sprint and it covers the Launch and Learn axis. It is also the culmination: whatever you have been building all semester should be the best version of itself by the end of it, and you should be able to explain the journey to someone who was not there.

Everyone in this class is building something different, in a different role. A solo builder is shipping their own product. Someone embedded on a team may be shipping a tool that serves their role on it. The bar is the same either way: something real, used by someone who is not you, and a clear account of what you learned.

**Deliverables:**

- What you built, live and deployed, reachable by someone else
- A 5-minute Loom video

**The 5-Minute Video**

1. **The problem** (~1 min). What problem are you solving, for whom, and why does it matter?
2. **Live demo** (~2.5 min). Walk through the real thing with real data. Do not narrate slides.
3. **Reflection** (~1.5 min). What did you learn? What would you do differently? What surprised you?

**Submit:** Your Loom URL on Canvas.

**Grading Philosophy:** You are graded on effort and learning, not on user acquisition. A thoughtful build with 3 engaged users beats a rushed one claiming 50 signups.
...
|-------|---------------------|
| **54-60** | Something a person outside this class would actually use. Core flow works reliably end to end. Visibly improved since Sprint 5. Deployed and stable. |
| **42-53** | Works and delivers value but has rough edges. You can tell it is a class project. Some iteration visible. Deployed. |
| **30-41** | Partially works. Incomplete flow or significant usability issues. Limited improvement since Sprint 5. |
| **18-29** | Barely functions. More mockup than working software. Little progress beyond Sprint 5. |
...
| Score | What this looks like |
|-------|---------------------|
| **36-40** | Live demo with real data. Clear problem and solution narrative. Honest reflection that talks about failures, not just wins. |
| **28-35** | Demo works, story is clear, but reflection is generic or the demo hits a few snags. |
